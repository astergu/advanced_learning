...
class NeuralNetwork:
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, test_data=None):
        ...
        @param:
            training_data: training input & expected output
            epochs: expected iteration times
            mini_batch_size: size of mini_batch block
            eta: learning rate
        """
        if test_data:
    ...
    def backprop(self, x, y):
        ...
        # used here to take advantage of the fact that Python can use
    ...
    def evaluate(self, test_data):
        ...
        outputs the correct result. Note ehtat the neural network's output
        is assumbed to be the index of whichever neuron in the final layer
